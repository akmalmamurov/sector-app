...
"[project]/src/app/api/auth/[provider]/callback/route.ts [app-route] (ecmascript)": ((__turbopack_context__) => {
"use strict";
...
async function GET(req, { params }) {
    ...
    if (!token) {
        ...
        return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].redirect("/login");
    }
    // HTTP-only, Secure, SameSite=None cookie ўрнатиш
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$headers$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["cookies"])().set({
        name: "sector-token",
        value: token,
        httpOnly: true,
        secure: true,
    ...
    return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].redirect("/profile");
}
...
//# sourceMappingURL=%5Broot%20of%20the%20server%5D__25f84d._.js.map