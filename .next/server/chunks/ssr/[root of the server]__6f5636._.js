...
;
const getBreadcrumbPaths = (catalogData, slug, categorySlug, includeBase = false)=>{
    let breadcrumbs = [];
    if (includeBase) {
        breadcrumbs.push({
            name: "Каталог",
    ...
    if (slug) {
        const catalogPath = (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$utils$2f$catalog$2d$slug$2e$ts__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["getCatalogPath"])(catalogData, slug);
        const catalogCrumbs = catalogPath.map((item, index, arr)=>({
                name: item.title,
                href: index < arr.length - 1 ? `/catalog/${arr.slice(0, index + 1).map((i)=>i.slug).join("/")}` : undefined,
                catalogItem: item
            }));
        breadcrumbs = [
            ...breadcrumbs,
    ...
    if (slug && categorySlug) {
        const subcatalogItem = (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$utils$2f$catalog$2d$slug$2e$ts__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["findCatalogItem"])(catalogData, slug);
        const categoryItem = subcatalogItem && subcatalogItem.categories ? subcatalogItem.categories.find((cat)=>cat.slug === categorySlug) : undefined;
        if (categoryItem) {
            breadcrumbs.push({
...
const SingleCatalogPage = async ({ params })=>{
    ...
    const slugString = (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$utils$2f$index$2e$ts__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__$3c$exports$3e$__["getSlugString"])(slug);
...
//# sourceMappingURL=%5Broot%20of%20the%20server%5D__6f5636._.js.map