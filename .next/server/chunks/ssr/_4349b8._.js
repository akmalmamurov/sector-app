...
;
;
// Dummy katalog ma'lumotlari – real loyihada bu maʼlumotlarni API yoki global context orqali olishingiz mumkin
const catalogData = [
    {
        id: "91d8e49c-d340-45b1-9ecb-052fa448a798",
        slug: "kompyutery-noutbuki-monitory-orgtekhnika",
        title: "Kompyuterlar va Texnika",
        subcatalogs: [
            {
                id: "b575176b-52a1-4851-a369-43116d2b84b1",
                slug: "rasprodazha-kompyuterov-orgtekhniki-i-komplektuyushchikh",
                title: "Распродажа компьютеров, оргтехники и комплектующих",
                categories: []
            }
        ]
    }
...
function SingleCatalog() {
    ...
    const parentSlug = params.slug; // URL'dan ota katalog slug
    const subcatalogSlug = searchParams.get("subcatalog");
    // Ota katalogni aniqlaymiz
    const parentCatalog = catalogData.find((item)=>item.slug === parentSlug);
    // Breadcrumb yo'llarini shakllantiramiz
    const breadcrumbPaths = [];
    if (parentCatalog) {
        breadcrumbPaths.push({
            name: parentCatalog.title,
            href: `/catalog/${parentCatalog.slug}`
        });
        if (subcatalogSlug && parentCatalog.subcatalogs) {
            const subcatalog = parentCatalog.subcatalogs.find((sc)=>sc.slug === subcatalogSlug);
            if (subcatalog) {
                breadcrumbPaths.push({
                    name: subcatalog.title,
                    href: `/catalog/${parentCatalog.slug}?subcatalog=${subcatalog.slug}`
                });
            }
        }
    }
            ...
            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                ...
                children: [
                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])("h1", {
                        ...
                        children: subcatalogSlug ? "Subcatalog Content" : "Catalog Content"
                    }, void 0, false, {
                        fileName: "[project]/src/app/catalog/[slug]/page.tsx",
                        lineNumber: 61,
                        columnNumber: 9
                    ...
                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])("p", {
                        className: "mt-2",
                        children: subcatalogSlug ? `Content for subcatalog (${subcatalogSlug}) under "${parentCatalog?.title}"` : `Content for catalog (${parentSlug})`
                    }, void 0, false, {
                        fileName: "[project]/src/app/catalog/[slug]/page.tsx",
                        lineNumber: 64,
                        columnNumber: 9
...
//# sourceMappingURL=_4349b8._.js.map