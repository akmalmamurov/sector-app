  ...
  return (
    <div className="p-[15px] flex justify-between items-center border-b border-superSilver">
      ...
      <div className="flex">
        ...
        >
          <div className="flex justify-between w-full items-center">
            <div className="flex items-center gap-2">
              <SortIconDesc />
              <span className="select-none font-normal text-textColor text-base leading-6">{selected || "Популярность"}</span>
            </div>
        ...
        >
          <div className="flex justify-between w-full items-center">
            <span className="select-none font-normal text-textColor text-base leading-6">{limit}</span>
